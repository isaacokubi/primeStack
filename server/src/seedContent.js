...
const content = [
  { type:'blog', title:'Building Software That Creates Measurable Business Value', slug:'building-software-measurable-business-value', description:'A practical look at turning complex business problems into dependable digital products.', content:'Great software starts with a real business problem. We combine product discovery, engineering discipline and continuous measurement to create systems that deliver lasting value.', category:'Product Engineering', author:'primeStack Engineering', published:true, publishedAt:new Date() },
  { type:'blog', title:'Designing for Scale From the First Release', slug:'designing-for-scale-from-the-first-release', description:'The architecture and product decisions that help growing software stay dependable.', content:'Scale is more than infrastructure. Strong domain boundaries, observable services, secure authentication and thoughtful user experience give products room to grow without unnecessary complexity.', category:'Technology', author:'primeStack Engineering', published:true, publishedAt:new Date() },
  { type:'case-studies', title:'Modernizing Operations With Workflow Automation', slug:'modernizing-operations-with-workflow-automation', description:'How a regional services organization replaced fragmented manual processes with a dependable digital workflow.', industry:'Professional Services', challenge:'Manual approvals and fragmented spreadsheets slowed daily operations.', solution:'primeStack designed a centralized workflow platform with automated approvals, notifications and operational dashboards.', technologies:['React','Node.js','MongoDB'], results:['Faster processing','Clearer ownership','Improved operational visibility'], metrics:[{label:'Processing time',value:'-45%'},{label:'Manual steps',value:'-60%'},{label:'Visibility',value:'+80%'}], published:true, publishedAt:new Date() },
  { type:'case-studies', title:'Turning Operational Data Into Decisions', slug:'turning-operational-data-into-decisions', description:'How unified analytics gave leadership a single source of truth for operational performance.', industry:'Commerce', challenge:'Leadership relied on delayed reports assembled from multiple systems.', solution:'We built a unified analytics experience with live KPIs, role-based dashboards and actionable reporting.', technologies:['React','Node.js','MongoDB'], results:['Reporting reduced from days to minutes','Six data sources unified','High team adoption'], metrics:[{label:'Reporting cycle',value:'Days → Minutes'},{label:'Data sources',value:'6 unified'},{label:'Adoption',value:'90%'}], published:true, publishedAt:new Date() },
  { type:'jobs', title:'Senior Full-Stack Engineer', slug:'senior-full-stack-engineer', description:'Build dependable product experiences across React, Node.js and MongoDB while shaping engineering standards.', department:'Engineering', location:'Nairobi, Kenya / Remote', employmentType:'Full-time', experienceLevel:'Senior', requirements:['Strong JavaScript and TypeScript fundamentals','Production React and Node.js experience','Experience designing REST APIs and data models'], responsibilities:['Build and review product features','Improve reliability and performance','Collaborate with product and design'], published:true, publishedAt:new Date() },
  { type:'jobs', title:'Product Designer', slug:'product-designer', description:'Design clear, useful experiences for complex business workflows and customer-facing products.', department:'Product', location:'Nairobi, Kenya / Remote', employmentType:'Full-time', experienceLevel:'Mid-level', requirements:['Strong product design portfolio','Experience with Figma and design systems','Ability to simplify complex workflows'], responsibilities:['Create user flows and prototypes','Maintain design consistency','Work closely with engineering and product'], published:true, publishedAt:new Date() }
];
